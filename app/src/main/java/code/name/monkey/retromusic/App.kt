...
import code.name.monkey.retromusic.network.DownloaderImpl
...
class App : Application() {
    ...
    override fun onCreate() {
        ...
        // Initialize NewPipe extractor for SoundCloud search
        try {
            NewPipe.init(DownloaderImpl.getInstance())
            Log.d("App", "NewPipe extractor initialized successfully")
        } catch (e: Exception) {
            Log.e("App", "NewPipe init failed: ${e.message}")
        }
        ...
        try {
            ...
            Log.e("App", "Billing init failed: ${e.message}")
        }
    ...
    companion object {
        ...
        fun isProVersion(): Boolean {
            return BuildConfig.DEBUG || (instance?.billingManager?.isProVersion ?: true)
        }
    }
}
